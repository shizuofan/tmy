...
func (a *App) CreateParagraph(chapterID int64, content, speaker, tone, voiceID string, speed int, volume int) (int64, error) {
	return a.chapterController.CreateParagraph(chapterID, content, speaker, tone, voiceID, speed, volume)
}
...
func (a *App) UpdateParagraph(id int64, content, speaker, tone, voiceID string, speed int, volume int, audioPath string, audioData string, duration float64, orderIndex int) error {
	return a.chapterController.UpdateParagraph(id, content, speaker, tone, voiceID, speed, volume, audioPath, audioData, duration, orderIndex)
}
